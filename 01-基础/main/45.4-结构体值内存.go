...
func main() {
	...
	fmt.Println(&pot.x, &pot.y) // 0xc0000aa070 0xc0000aa078 ;int类型的就占用的是8个字节, 如果是字符串类型是怎么连续的呢?

	var rec1 = Rect{Point{20, 30}, Point{50, 100}}
	fmt.Println(&rec1.leftup.x, &rec1.leftup.y, &rec1.rightup.x, &rec1.rightup.y) // 0xc0000122c0 0xc0000122c8 0xc0000122d0 0xc0000122d0属性的属性值依然是连续的
